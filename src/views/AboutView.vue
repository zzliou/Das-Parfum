    ...
    <div class="container">
      <div class="storyWrapper">
        <div class="icon">
          ...
          >
            <title aria-label="Aesop 商標" id="aesop-86">Aesop</title>
            <g>
              <path
      ...
      <div class="wisdom">
        <div class="title">‘If the path be beautiful, let us not ask where it leads.’
</div>
        <div class="subtitle">Anatole France</div>
      </div>
    </div>
  </div>
</template>
